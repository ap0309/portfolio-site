  ...
  const skillCategories = [
    {
      ...
      skills: [
        ...
        { name: "Python", level: 75, icon: "devicon-python-plain" }
      ]
    },
    {
      ...
      icon: "fas fa-globe",
      skills: [
        { name: "HTML", level: 85, icon: "devicon-html5-plain" },
        { name: "CSS", level: 80, icon: "devicon-css3-plain" },
        { name: "JavaScript", level: 75, icon: "devicon-javascript-plain" },
        { name: "ExpressJS", level: 80, icon: "devicon-express-original" }
      ]
    },
    {
      title: "Databases",
      ...
      skills: [
        { name: "MongoDB", level: 85, icon: "devicon-mongodb-plain" },
    ...
    },
    {
      ...
      icon: "fas fa-tools",
      skills: [
        { name: "Git", level: 80, icon: "devicon-git-plain" },
        { name: "GitHub", level: 85, icon: "devicon-github-original" },
        { name: "Linux", level: 75, icon: "devicon-linux-plain" },
        { name: "AWS Cloud Foundations", level: 90, icon: "devicon-amazonwebservices-original" }
      ]
    }
  ];
